...
import 'package:myvtsproject/config/apps/food_delivery/constant.dart';
...
class GlobalStyle {
  ...
  static const TextStyle userProfileTitle =
      TextStyle(fontSize: 15, color: back77, fontWeight: FontWeight.normal);
  ...
  static const TextStyle orderNotes = TextStyle(fontSize: 12, color: softGrey);

  static const TextStyle orderAction =
      TextStyle(fontSize: 12, color: primaryColor, fontWeight: FontWeight.bold);

  static const TextStyle couponAction =
      TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: softBlue);

  static const TextStyle orderTotalSubtitle =
      TextStyle(fontSize: 14, color: back77);

  static const TextStyle orderTotalTitle =
      TextStyle(fontSize: 14, color: Colors.black, fontWeight: FontWeight.bold);

  static const TextStyle preferredMerchant =
  ...
  static const TextStyle restaurantTag =
      TextStyle(color: softGrey, fontSize: 13);

  static const TextStyle menuTitle =
      TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: back77);
  ...
  static const TextStyle restaurantFoodDesc =
      TextStyle(fontSize: 12, color: softGrey);
