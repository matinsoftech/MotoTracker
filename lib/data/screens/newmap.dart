...
class GoogleMaps6Page extends StatefulWidget {
  ...
  @override
  GoogleMaps6PageState createState() => GoogleMaps6PageState();
}

class GoogleMaps6PageState extends State<GoogleMaps6Page> {
            ...
            for (int i = 0; i < StaticVarMethod.devicelist.length; i++) {
              if (StaticVarMethod.devicelist[i].lat != 0) {
                ...
                _allMarker[MarkerId(i.toString())] = Marker(
                  ...
                  position: position,
                  rotation: StaticVarMethod.devicelist[i].course,
