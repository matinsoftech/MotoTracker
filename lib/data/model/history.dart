...
class Device {
  ...
  Device.fromJson(dynamic json) {
    ...
    _name = json['name'];
    _imei = json['imei'];
    _fuelMeasurementId = json['fuel_measurement_id'].toString();
  ...
  String? get fuelMeasurementId => _fuelMeasurementId;
...
class AllItems {
  ...
  AllItems.fromJson(dynamic json) {
    ...
    _otherArr =
        json['other_arr'] != null ? json['other_arr'].cast<String>() : [];
